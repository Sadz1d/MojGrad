...
namespace Market.Application.Modules.Volunteering.Commands.Update;

public sealed class UpdateVolunteerActionCommandValidator
    : AbstractValidator<UpdateVolunteerActionCommand>
{
    public UpdateVolunteerActionCommandValidator()
    {
